@extends('template')
@section('head')
<title>Page d'article complet</title>
@section('contenu')
<div id="main" class="with_sidebar right_sidebar">
			...
			<div id="breadcrumbs_area">
				<div id="breadcrumbs_inner">
					<h4 class="title">Awesome Slider Post</h4>
					<ul class="breadcrumbs">
						<li class="home"><a href="index.html">Home</a></li>
						<li class="all"><a href="blog1.html">All Posts</a></li>
						<li class="all"><a href="categories.html">Media</a></li>
						<li class="current">Awesome Slider Post</li>
					</ul>
				</div>
			</div>
			<!-- /Page title and breadcrumbs -->
				...
				<div id="content" class="content_blog blog_style_b1 post_single" role="main">
					...
					<article class="post_format_gallery">
						...
						<div class="post_info_1">
	                        ...
	                        <div class="post_comments"><a href="#comments"><span class="comments_number">0</span><span class="icon-comment"></span></a></div>
						</div>

						<div class="title_area">
							<h1 class="post_title"><a href="#">Awesome Slider Post</a></h1>
						</div>
						...
						<div class="post_content">
							...
							<div class="sc_slider sc_slider_flex sc_slider_border">
								<ul class="slides">
									<li><a href="http://placehold.it/790x391" class="prettyPhoto"><img alt="" src="http://placehold.it/790x391" height="391" width="790"></a></li>
									<li><a href="http://placehold.it/790x391" class="prettyPhoto"><img alt="" src="http://placehold.it/790x391" height="391" width="790"></a></li>
									<li><a href="http://placehold.it/790x391" class="prettyPhoto"><img alt="" src="http://placehold.it/790x391" height="391" width="790"></a></li>
								</ul>
							</div>
							...
							in sit amet odio. Etiam ut mattis orci, a tristique risus. Praesent 
							scelerisque eu urna quis scelerisque. Aenean ut leo mattis, aliquet 
							tellus in, placerat risus. Curabitur ultrices imperdiet convallis. Nam 
							scelerisque, augue at feugiat cursus, lorem justo hendrerit justo, et 
							mattis enim diam vel ipsum.</p>
							...
							euismod sed at neque. Pellentesque id semper risus. Phasellus vel 
							dignissim quam, sed fringilla mi. Ut rhoncus diam nec enim tempus, non 
							porta neque posuere. Ut facilisis egestas laoreet. Nam condimentum 
							tempor tellus, non condimentum quam vestibulum ut. Quisque convallis id 
							sapien eget egestas.</p>
							<p>Etiam tincidunt enim nec lorem tristique, et ultrices tortor mattis. 
							Proin imperdiet porttitor pulvinar. Sed dapibus purus nisl, eu 
							condimentum tellus rutrum vitae. Fusce iaculis felis tempor leo iaculis 
							mattis. Cras aliquet magna id felis iaculis, vitae rutrum dui 
							pellentesque. Suspendisse malesuada sapien id dapibus lobortis. 
							Phasellus vel venenatis neque, ac varius justo. Vivamus rutrum dignissim
							 vulputate. Integer nec odio iaculis, molestie lectus eu, ultrices nibh.
							 Aliquam feugiat accumsan velit placerat condimentum. Integer consequat 
							felis sollicitudin felis tempor tempus. Nulla accumsan aliquet 
							facilisis. Suspendisse nulla ante, ornare sit amet ultricies vitae, 
							faucibus nec dui. Vivamus molestie mattis massa id commodo. Cras feugiat
							 laoreet mauris. Nullam pellentesque volutpat nulla vitae vulputate.</p>
							<p>Sed non metus eget nunc dapibus vehicula id vitae elit. Etiam et nisl
							 ipsum. Nulla luctus lorem sed purus viverra dignissim. Sed laoreet quis
							 augue nec consequat. Pellentesque et arcu tellus. Quisque varius sem a 
							placerat semper. Morbi auctor leo sed sollicitudin tempus.</p>
							<p>Donec nec ipsum vitae mauris luctus scelerisque. Curabitur nunc 
							risus, auctor at porta et, fermentum non nunc. Vestibulum ante ipsum 
							primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nam 
							gravida tellus eu quam fringilla gravida. Donec laoreet dolor non nunc 
							blandit, vitae sagittis odio molestie. Morbi eget neque nisl. 
							Suspendisse porta blandit consectetur. Sed a ligula at mauris pulvinar 
							ullamcorper eget vel urna. Sed et semper tortor, quis consequat lectus. 
							Duis quis vestibulum sem. Nullam libero turpis, ultrices nec elit vitae,
							 porttitor faucibus felis. Interdum et malesuada fames ac ante ipsum 
							primis in faucibus. Donec ac rhoncus dui.</p>
						</div>
					...
					<div id="related_posts">
						...
						<div class="subtitle_area">
							<h2 class="post_subtitle">Article du même genre</h2>
						</div>
						...
						<div id="respond" class="comment-respond">
							...
							<form action="#" method="post" id="commentform" class="comment-form">
								...
								<p class="comment-form-email">
									<label for="email" class="required">Email <span class="required">(requis)</span></label>
					...
					<aside class="widget-number-1 widget widget_popular_posts">
						<div class="popular_and_commented_tabs sc_tabs">
							<div class="tab_names tabs">
								<a class="current" href="#tab_popular"><span>Popular</span></a><a href="#tab_comments"><span>Comments</span></a>
							</div>
							<!-- Tab popular -->
							<div class="tab_content" id="tab_popular">
								<div class="post_item first">
									...
									<div class="post_info">
										...
										<span class="post_info_delimiter"></span>
										<span class="post_comments"><a href="post-standard-b1.html"><span class="icon-eye"></span><span class="post_comments_number">188</span></a></span>
									</div>
								</div>
								<div class="post_item">
									<h4 class="post_title"><a href="post-video-b1.html">This is a Video Post</a></h4>
									<div class="post_author">By: <a href="author.html">John Snow</a></div>
									<div class="post_info">
										<span class="post_date">March 3, 2013</span>
										<span class="post_info_delimiter"></span>
										<span class="post_comments"><a href="post-video-b1.html"><span class="icon-eye"></span><span class="post_comments_number">84</span></a></span>
									</div>
								</div>
								<div class="post_item">
									<h4 class="post_title"><a href="post-standard-b1.html">Nullam nulla libero</a></h4>
									<div class="post_author">By: <a href="author.html">John Snow</a></div>
									<div class="post_info">
										<span class="post_date">March 2, 2013</span>
										<span class="post_info_delimiter"></span>
										<span class="post_comments"><a href="post-standard-b1.html"><span class="icon-eye"></span><span class="post_comments_number">81</span></a></span>
									</div>
								</div>
								<div class="post_item">
									...
									<div class="post_info">
										<span class="post_date">May 30, 2013</span>
										<span class="post_info_delimiter"></span>
										<span class="post_comments"><a href="post-gallery-b1.html"><span class="icon-eye"></span><span class="post_comments_number">39</span></a></span>
									</div>
								</div>
							</div>
							<!-- /Tab popular -->
							...
							<!-- Tab comments -->
							<div style="display: none;" class="tab_content" id="tab_comments">
								<div class="post_item first">
									<h4 class="post_title"><a href="post-standard-b1.html">This is a Standard post</a></h4>
									<div class="post_author">By: <a href="http://norma.36.wp/author/john/">John Snow</a></div>
									<div class="post_info">
										<span class="post_date">June 24, 2013</span>
										<span class="post_info_delimiter"></span>
										<span class="post_comments"><a href="http://norma.36.wp/post-standard-b1.html#comments"><span class="icon-comment"></span><span class="post_comments_number">3</span></a></span>
									</div>
								</div>
								<div class="post_item">
									<h4 class="post_title"><a href="post-standard-b1.html">Lorem ipsum dolor sit amet</a></h4>
									<div class="post_author">By: <a href="author.html">John Snow</a></div>
									<div class="post_info">
										<span class="post_date">February 15, 2013</span>
										<span class="post_info_delimiter"></span>
										<span class="post_comments"><a href="post-standard-b1.html#comments"><span class="icon-comment"></span><span class="post_comments_number">0</span></a></span>
									</div>
								</div>
								<div class="post_item">
									<h4 class="post_title"><a href="post-standard-b1.html">Vivamus vitae mauris ullamcorper</a></h4>
									<div class="post_author">By: <a href="author.html">John Snow</a></div>
									<div class="post_info">
										<span class="post_date">February 23, 2013</span>
										<span class="post_info_delimiter"></span>
										<span class="post_comments"><a href="post-standard-b1.html#comments"><span class="icon-comment"></span><span class="post_comments_number">0</span></a></span>
									</div>
								</div>
								<div class="post_item">
									<h4 class="post_title"><a href="post-standard-b1.html">Consectetur adipisicing elit</a></h4>
									<div class="post_author">By: <a href="author.html">John Snow</a></div>
									<div class="post_info">
										<span class="post_date">February 26, 2013</span>
										<span class="post_info_delimiter"></span>
										<span class="post_comments"><a href="post-standard-b1.html#comments"><span class="icon-comment"></span><span class="post_comments_number">0</span></a></span>
									</div>
								</div>
